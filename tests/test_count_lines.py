...
'''
    ...
    """Async docstring."""
    pass # inline comments count as code, not as comment lines
'''
...
class TestDocstringExclusions:
    ...
    def test_string_literals_count_as_code(self) -> None:
        """Triple-quoted strings in assignments count as code."""
...
'''
    ...
    def test_multiline_string_literals_count_as_code(self) -> None:
...
class TestCommentClassification:
    ...
    def test_standalone_comments_count_as_comments(self) -> None:
        """Comment-only lines count as comments, blank line counts as code."""
    ...
    def test_inline_comment_counts_as_code(self) -> None:
        """Line with inline comment is counted as code, not as a comment."""
...
class TestCodeLinesClassification:
    """Tests for basic code detection."""

    def test_code_statements(self) -> None:
        """Code statements are counted correctly."""
...
class TestBlankLineHandling:
    """Tests for blank line behaviour."""

    def test_single_blank_line(self) -> None:
        """Single blank line counts as code."""
        content = "\n"
    ...
    def test_blank_lines_between_code_count_as_code(self) -> None:
        """Blank lines between code count as code."""
        content = "\n\nx = 1\n\n\ny = 2\n\n"
        ...
        _assert_count("docstring line(s)", 0, docstrings_cnt)
        _assert_count("comment line(s)", 0, comments_cnt)
        _assert_count("code line(s)", 7, code_cnt)

    def test_multiple_blank_lines_count_as_code(self) -> None:
...
"""
        ...
        _assert_count("docstring line(s)", 0, docstrings_cnt)
        _assert_count("comment line(s)", 0, comments_cnt)
        _assert_count("code line(s)", 6, code_cnt)
...
'''
        ...
        # - Code: 28 (assignments:3 + function defs:2 + function body:6
        ...
        _assert_count("code line(s)", 28, code_cnt)
